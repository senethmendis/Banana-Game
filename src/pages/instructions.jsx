...
function instructions() {
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-[#3191B0] bg-opacity-80 rounded-3xl w-11/12 h-5/6 flex flex-col">
        <Profile_btn />
        <div className="text-2xl font-itim ml-10 text-white overflow-y-auto h-fit sm:flex-grow lg:flex-grow no-scrollbar">
          ...
          <h1 className="md:text-lg">
            ...
            <div className="ml-16">
              <ul className="list-disc">
                <li>
                  <h1>
                    Certified Cherry: You have 5 lives and 30 seconds per
                    question.
                  </h1>
                </li>
                <li>
                  <h1>
                    Getting There: You have 3 lives and 20 seconds per question.
                  </h1>
                </li>
                <li>
                  <h1>
                    Tomato Crusher: You have 3 lives and 15 seconds per
                    question.
                  </h1>
                </li>
              </ul>
          ...
          <h1 className="md:text-lg ">
            <span className="font-bold text-3xl">Restart: </span>If you wish to
            restart the game at any time, you can do so from the restart button.
          </h1>
          <h1 className="text-center text-4xl mt-7">
            Have Fun!: Enjoy the challenge and test your math skills in the Mega
            Banana Game!
          </h1>
        </div>
      </div>
