			...
			<div className="bg-[#3191B0] bg-opacity-80 rounded-3xl w-11/12 h-5/6 flex justify-center items-center">
				...
				<div className="bg-white w-4/12 text-center rounded-3xl">
							...
							{loading ? (
								<svg
									...
									<path
										...
										fill="currentColor"
										d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 4.418 3.582 8 8 8v-4zm2-2.582V20c4.418 0 8-3.582 8-8h-4a3.993 3.993 0 01-3.532 3.984l-.734.147z"></path>
								</svg>
							) : (
								"Log In"
							)}
					...
					<h1 className="text-lg mb-10">
						...
						<Link
							to="/Registration"
							className="cursor-pointer text-[#0090CE]">
							&nbsp;Sign Up
						</Link>
					</h1>
				</div>
